export const TILE_IMAGES = {
    ...
    stone:           'tiles/stone.png',        // 街の石畳
    town_road:       'tiles/town_road.png',    // 街の道（未配置ならフォールバック描画）
    town_gate:       'tiles/town_gate.png',    // 街入口
    dungeon_gate:    'tiles/dungeon_gate.png', // ダンジョン入口
    mountain:        'tiles/mountain.png',
    // ── ダンジョン ──────────────────────────────────────────────
    cave_floor:      'tiles/cave_floor.png',
    cave_wall:       'tiles/cave_wall.png',
    cave_water:      'tiles/cave_water.png',
    cave_crystal:    'tiles/cave_crystal.png', // 花→結晶
    // ── 建物（外観 2×2 タイル） ─────────────────────────────────
    house_tl:        'tiles/house_tl.png',     // 左上
    house_tr:        'tiles/house_tr.png',     // 右上
    house_bl:        'tiles/house_bl.png',     // 左下（汎用）
    house_br:        'tiles/house_br.png',     // 右下
    house_inn_bl:    'tiles/house_inn_bl.png', // 宿屋 左下
    house_shop_bl:   'tiles/house_shop_bl.png',// 道具屋 左下
    // ── 建物（内装） ────────────────────────────────────────────
    house_floor:     'tiles/house_floor.png',
    house_wall:      'tiles/house_wall.png',
    house_furniture: 'tiles/house_furniture.png', // 家具（HOUSE タイル）
    house_exit:      'tiles/house_exit.png',   // 出口（TOWN_GATE）
    // ── 装飾・拡張タイル ────────────────────────────────────────
    small_rock:      'sprites/objects/small_rock.png',
    flower:          'sprites/objects/flower.png',
    dirt_path:       'tiles/dirt_path.png',
    cracked_floor:   'tiles/cracked_floor.png',
    barrel:          'sprites/objects/barrel.png',
    crate:           'sprites/objects/crate.png',
    cave_rock:       'tiles/cave_rock.png',
    cave_wall_edge:  'tiles/cave_wall_edge.png',
    dead_grass:      'tiles/dead_grass.png',
    root:            'sprites/objects/root.png',
    poison_swamp:    'tiles/poison_swamp.png',
    cursed_edge:     'tiles/cursed_edge.png',
    cursed_grass:    'tiles/cursed_grass.png',
    cursed_floor:    'tiles/cursed_floor.png',
    // ── 魔王城 ─────────────────────────────────────────────────
    castle_floor:     'tiles/castle_floor.png',
    castle_wall:      'tiles/castle_wall.png',
    castle_wall_edge: 'tiles/castle_wall_edge.png',
    castle_gate:      'tiles/castle_gate.png',
    throne_floor:     'tiles/throne_floor.png',
};
...
export const OBJECT_IMAGE_SOURCES = {
    chest:      ['sprites/objects/chest.png', 'sprites/objects/chest_closed.png', 'tiles/chest_closed.png'],
    chest_open: ['sprites/objects/chest_open.png', 'sprites/objects/chest_opened.png', 'tiles/chest_opened.png'],
    ...
    dark_castle_object: ['sprites/objects/dark_castle.png', 'tiles/dark_castle.png'],
